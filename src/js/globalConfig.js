...
export default {
    dittNav: {
        ...
        DITTNAV_API_AUTH_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/authPing`,
        DITTNAV_OPPFOLGING_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/oppfolging`,
        DITTNAV_MELDEKORT_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/meldekortinfo`,
        DITTNAV_PERSON_NAVN_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/personalia/navn`,
        DITTNAV_PERSON_IDENT_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/personalia/ident`,
        DITTNAV_SAKER_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/saker/paabegynte`,
        DITTNAV_MELDINGER_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/meldinger/ubehandlede`,
        DITTNAV_API_PING_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/ping`,
        DITTNAV_HENDELSER_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-api/brukernotifikasjoner`,
        DITTNAV_EVENT_TEST: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-event-test-producer`,
        DITTNAV_SAKSTEMA_URL: `${window.env.DITTNAV_BASEAPI_URL}/dittnav-legacy-api/saker/sakstema`,
