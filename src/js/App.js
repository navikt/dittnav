          ...
          <div className="row">
            <div className="maincontent side-innhold">
              <div className="col-md-12">
                ...
                <InfoMeldinger pleiepenger={s.info.pleiepenger} paabegynteSaker={s.paabegynteSaker.paabegynte} meldekort={s.info.meldekort} isRegisteredAtIArbeid={s.info.personInfo ? s.info.personInfo.isRegisteredAtIArbeid : null} />
