...
export default {
  dittNav: {
    ...
    ARBEIDSGIVER_LOGIN_URL:
      "https://www.nav.no/no/Bedrift/Tjenester+og+skjemaer/NAV-+og+Altinn-tjenester"
  },
  ...
  PSELV_LOGIN_LINK_UT_URL:
    "/pselv/tilleggsfunksjonalitet/innlogging.jsf?context=ut"
};
