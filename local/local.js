...
app.get('/dittnav-legacy-api/oppfolging', (req, res) => res.sendFile(path.resolve(__dirname, './mock/oppfolging.json')));
app.get('/dittnav-legacy-api/meldekortinfo', (req, res) => res.sendFile(path.resolve(__dirname, './mock/meldekortinfo.json')));
app.get('/dittnav-legacy-api/personalia/navn', (req, res) => res.sendFile(path.resolve(__dirname, './mock/person-navn.json')));
app.get('/dittnav-legacy-api/personalia/ident', (req, res) => res.sendFile(path.resolve(__dirname, './mockperson-ident.json')));
app.get('/dittnav-legacy-api/saker/paabegynte', (req, res) => res.sendFile(path.resolve(__dirname, './mock/paabegynte.json')));
app.get('/dittnav-legacy-api/meldinger/ubehandlede', (req, res) => res.sendFile(path.resolve(__dirname, './mock/ubehandlede.json')));
app.get('/dittnav-legacy-api/saker/sakstema', (req, res) => res.sendFile(path.resolve(__dirname, './mock/sakstema.json')));
